...
export const metadata: Metadata = {
  ...
  description:
    "Khám phá phong cách sống xanh sạch cùng MenuGreen. Tính toán chỉ số sức khỏe, đo lường năng lượng sinh khí và khám phá thực đơn hữu cơ thiết kế riêng cho thể trạng của bạn.",
  keywords: [
    "ăn xanh",
    "sống sạch",
    "thực đơn healthy",
  ...
  openGraph: {
    title: "MenuGreen - Thực Đơn Xanh & Cân Bằng Dinh Dưỡng Lành Mạnh",
    description:
      "Giải pháp ăn uống sạch hữu cơ tối giản giúp thanh lọc cơ thể, tối ưu chỉ số BMI và tăng cường sinh khí.",
    url: "https://menugreen.food",
    siteName: "MenuGreen",
    locale: "vi_VN",
    type: "website",
  },
