    ...
    <footer className="bg-slate-900 text-slate-300 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2 text-sm text-slate-400">
              ...
              <li><a href="#pricing" className="hover:text-primary-light transition-colors">Gói dịch vụ</a></li>
            </ul>
          </div>

          {/* Resources */}
          <div className="md:col-span-1">
            <h3 className="text-white font-semibold text-sm tracking-wider uppercase mb-4">Chính Sách</h3>
            <ul className="space-y-2 text-sm text-slate-400">
              <li><a href="#" className="hover:text-primary-light transition-colors">Về MenuGreen</a></li>
              <li><a href="#" className="hover:text-primary-light transition-colors">Chính sách bảo mật</a></li>
              <li><a href="#" className="hover:text-primary-light transition-colors">Điều khoản dịch vụ</a></li>
              <li><a href="#" className="hover:text-primary-light transition-colors">Tuyển dụng</a></li>
            </ul>
          </div>

          {/* Contact */}
          <div className="md:col-span-1 flex flex-col gap-3 text-sm text-slate-400">
            <h3 className="text-white font-semibold text-sm tracking-wider uppercase mb-4">Liên Hệ</h3>
            ...
            <div className="flex gap-4 mt-2">
              <a href="#" aria-label="Facebook" className="p-2 rounded-full bg-slate-800 hover:bg-primary hover:text-white transition-colors">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/>
                </svg>
              </a>
              <a href="#" aria-label="Instagram" className="p-2 rounded-full bg-slate-800 hover:bg-primary hover:text-white transition-colors">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <a href="#" aria-label="Website" className="p-2 rounded-full bg-slate-800 hover:bg-primary hover:text-white transition-colors">
        ...
        <div className="pt-8 border-t border-slate-800 text-center text-xs text-slate-500 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p suppressHydrationWarning>© {new Date().getFullYear()} MenuGreen. All rights reserved.</p>
