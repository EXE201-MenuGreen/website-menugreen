  ...
  const plans = [
    {
      ...
      price: "80.000",
      period: "tháng",
      description: "Xem nhanh gợi ý thực đơn thích hợp dựa trên ngân sách bữa ăn của ngày hôm đó.",
      features: [
        "Xem đề xuất nhanh gọn theo ngân sách",
        "Tùy chọn mức chi trả cho bữa ăn mỗi ngày",
        "Tạo danh sách thực đơn 10 món ăn tối ưu",
        "Giao diện thân thiện và dễ dàng thao tác",
      ],
      popular: false,
      ctaText: "Đăng Ký Gói Cá Nhân",
    },
    {
      ...
      price: "100.000",
      period: "tháng",
      description: "Sắp xếp thông minh, tối ưu nguyên liệu sẵn có trong tủ lạnh gia đình và lên lịch ăn tuần.",
      features: [
        "Đầy đủ các tính năng của gói Cá Nhân",
        "Mở khóa quét tủ lạnh không giới hạn",
        "AI lập lịch ăn uống thông minh",
        "Báo cáo thống kê tiết kiệm chi tiêu tuần",
      ],
      popular: true,
      ctaText: "Đăng Ký Gói Văn Phòng",
    },
    {
      icon: <Dumbbell className="w-6 h-6 text-primary" />,
      title: "Gói Chuyên Sâu / Gymer",
      price: "180.000",
      period: "tháng",
      ...
      popular: false,
      ctaText: "Đăng Ký Gói Chuyên Sâu",
    },
  ];
